...
def optimize_num_topics(candidate_num_topics: List[int], corpus: List[List[str]], 
                        dictionary, bow_corpus, target: Path, repetitions: int = 3, save: bool = False) -> None:
    coherence_umass = []
    coherence_cv = []
    perplexity = []
...
def optimize_no_above(candidate_no_above: List[int], corpus: List[List[str]],
                      target: Path, repetitions: int = 10, num_topics: int = 8, save: bool = False):
    coherence_umass = []
    coherence_cv = []
    perplexity = []
    ...
    for k in candidate_no_above:
        ...
        dictionary = TopicModeler.create_dictionary(corpus, no_above=k)
